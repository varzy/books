...
网景推出 JavaScript 时正值第一次浏览器大战如火如荼，为了迎战网景的 JavaScript，微软也推出了自家的脚本语言 JScript，并且添加了一大堆的专属特性。

咦？等等，网景浏览器不是被 IE 打败了吗？那为什么现在大家常说的 JS 是指 JavaScript 而不是 JScript 呢？
...
好了，故事就此打住，前端开发的基建基本完毕，像我们这样的工程师是时候登场了。
